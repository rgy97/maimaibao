window.onload = function () {
  ...
  var btn = document.getElementById("btn"); //给注册注册点击事件
  ...
  btn.onclick = function () {
    ...
    if (name && password) {
      ...
      setCookie("login_left", JSON.stringify(arr)); // document.cookie = encodeURIComponent(name) + "=" +password+ ";expires="+date+";path=/";
